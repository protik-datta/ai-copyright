...
const GeneratorOutput = ({ result, error, loading }) => {
  ...
  return (
    <div className="bg-[#f8f9fc] rounded-2xl p-4 sm:p-6 md:p-8 border border-gray-100 flex-1 flex flex-col relative min-h-100 sm:min-h-125 lg:min-h-125">
      <div className="flex justify-between items-center mb-4 sm:mb-6">
        <h2 className="text-[17px] sm:text-[20px] font-bold text-gray-900 flex items-center gap-2">
          <FileText size={18} className="text-[#5044E5] sm:w-5 sm:h-5" />
          Generated Output
        </h2>
        <button
          onClick={handleCopy}
          disabled={!result || loading}
          className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white border border-gray-200 text-gray-700 text-[12px] sm:text-[13.5px] font-semibold rounded-lg hover:border-[#5044E5] hover:text-[#5044E5] transition-all cursor-pointer shadow-sm disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:border-gray-200 disabled:hover:text-gray-700"
        >
      ...
      <div className="flex-1 bg-white rounded-xl border border-gray-200 p-4 sm:p-6 overflow-y-auto relative shadow-[inset_0_2px_10px_rgba(0,0,0,0.01)]">
        {loading ? (
          ...
          <div className="h-full flex items-center justify-center text-red-500 text-[13.5px] sm:text-[14.5px] font-medium bg-red-50/50 rounded-lg border border-red-100/50 p-4 sm:p-6 text-center">
          ...
          <div className="h-full flex flex-col items-center justify-center text-center text-gray-400 gap-3 sm:gap-4">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-indigo-50 flex items-center justify-center mb-1 ring-8 ring-white shadow-sm">
              <FileText size={28} className="text-[#5044E5]/40 sm:w-8 sm:h-8" />
            </div>
            <p className="text-[13.5px] sm:text-[14.5px] font-medium max-w-50 sm:max-w-55 leading-relaxed text-gray-400">
